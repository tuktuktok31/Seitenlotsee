...
// OpenAI-compatible endpoint. Model used: openai/gpt-oss-20b:free
// ($0 — a free-tier model. 21B open-weight model from OpenAI (Apache 2.0),
// MoE architecture with ~3.6B active params per forward pass, so it should
// be fast. German quality is not specifically confirmed — worth testing on
// real conversations. Still subject to free-tier deprioritization under
// load — see caveats below.)
//
...
// - Fallback free options if this ID gets delisted: nvidia/nemotron-3-nano-30b-a3b:free
//   or google/gemma-4-26b-a4b-it:free (both confirmed live and free on
