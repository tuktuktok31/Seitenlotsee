...
// OpenAI-compatible endpoint. Model used: nvidia/nemotron-3-super-120b-a12b:free
// ($0 — a free-tier model. 120B-parameter hybrid Mamba-Transformer MoE
// model, ~12B active params per token — a much larger, stronger model than
// the earlier Nemotron Nano attempt, with a 1M-token context window.
// German quality is not specifically confirmed — worth testing on real
// conversations. Still subject to free-tier deprioritization under load —
// see caveats below.)
//
...
// - Fallback free options if this ID gets delisted, or if quality/speed
//   turns out to be an issue: google/gemma-4-26b-a4b-it:free or
//   openai/gpt-oss-20b:free (smaller, faster, previously tried in this
//   project) — check openrouter.ai/models before relying on any of these,
