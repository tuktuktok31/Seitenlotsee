...
// ($0 — a free-tier model. The most established, longest-running free
// model on OpenRouter, with confirmed strong German support. Note: it's a
// larger 70B dense model, so it may respond slower than smaller models
// like Gemma, and is still subject to free-tier deprioritization under
...
//   low-volume, non-critical, or testing use. If speed is still a problem
//   after this change, the paid anthropic/claude-haiku-4.5 is very cheap
//   ($1 input / $5 output per million tokens) and isn't deprioritized.
//
// SETUP:
