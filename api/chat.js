...
// ($0 — a free-tier model. 70B instruction-tuned Llama, 131K context.
// Meta's own model card for 3.3 70B Instruct explicitly lists German as a
// supported language, which fits this bot's use case well. Still subject
// to free-tier deprioritization under load — see caveats below.)
//
...
// - Fallback free option if this ID gets delisted: nvidia/nemotron-3-nano-30b-a3b:free
//   (smaller/faster MoE model, but German quality wasn't specifically verified).
//
// SETUP:
