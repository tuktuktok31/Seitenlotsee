...
// custom LPU hardware. Model used: meta-llama/llama-4-scout-17b-16e-instruct
// ($0 — Groq's free developer tier. Mixture-of-experts Llama 4 model with a
// large context window. German quality is not specifically confirmed —
// worth testing on real conversations. If it turns out too weak, Qwen3 32B
// is another free option on Groq worth comparing.)
//
...
// - Groq's free-tier model roster changes over time — verify this model
//   ID is still listed at console.groq.com/docs/models before deploying,
//   and have a fallback ready in case it's removed.
