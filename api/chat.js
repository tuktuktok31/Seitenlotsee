...
//
// This currently talks to NaraRouter (https://router.bynara.id), a third-party
// gateway offering free daily token quotas via an OpenAI-compatible endpoint.
// NOTE: NaraRouter is NOT operated by Anthropic, and its domain has already
// changed once (router.naraya.ai stopped resolving). For a paid, customer-facing
// product, an official Anthropic API key is the more reliable long-term option —
// see the commented-out block below to swap to it.
//
// SETUP:
// 1. Put this file at:  api/chat.js  (at the root of your project, next to your index.html)
// 2. In your Vercel project settings → Environment Variables, add:
//      NARAROUTER_API_KEY = sk-nry-...   (from https://router.bynara.id/keys)
