...
//
// NOTE: "openrouter/free" is OpenRouter's auto-router, not a specific
// language model ID. It may not behave like a normal chat model, and some
// free-model trackers exclude it entirely for that reason. If requests
// start failing or behaving oddly, swap this for an actual ":free" model
// ID (e.g. "meta-llama/llama-3.3-70b-instruct:free") — verify current
// options at openrouter.ai/models (filter by price, ascending).
//
// SETUP:
