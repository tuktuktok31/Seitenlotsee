...
// OpenAI-compatible endpoint. Model used: google/gemma-4-26b-a4b-it:free
// ($0 — a free-tier model. Instruction-tuned MoE model from Google DeepMind,
// 25.2B total params but only ~3.8B active per token, so it should be fast.
// Gemma models are generally well regarded for multilingual quality, but
// German performance specifically wasn't independently verified here —
// worth testing on real conversations. Still subject to free-tier
...
// - Fallback free options if this ID gets delisted: openai/gpt-oss-20b:free
//   or nvidia/nemotron-3-nano-30b-a3b:free (both confirmed live and free on
//   OpenRouter as of this writing — check openrouter.ai/models before relying
//   on any of these, since free IDs rotate without notice).
//
// SETUP:
